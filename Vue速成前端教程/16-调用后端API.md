...
- 前置教程：[15 - 文章详情页](../15-文章详情页/)
- 可视化：有，vue_16_api_visual.html
...
下一篇：[17 - 用户注册登录](../17-用户注册登录/)，实现注册和登录表单，接收后端返回的 token，存到 localStorage，导航栏根据登录状态显示不同内容。
