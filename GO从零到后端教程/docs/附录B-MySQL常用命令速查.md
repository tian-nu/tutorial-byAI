...
mysqldump -u root -p --all-databases > all_backup.sql  *(注意：包含mysql等系统库，一般用--databases指定业务库更安全)*
...
---
[← 上一章：附录A-Go标准库速查.md](附录A-Go标准库速查.md) | [下一章：附录C-Redis命令速查.md →](附录C-Redis命令速查.md)
